...
public class ArrayAdapterOcorrencia extends ArrayAdapter<Ocorrencia> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView textoTipoOcorrencia = convertView.findViewById(R.id.texto_tipo_ocorrencia);
        TextView textoStatus = convertView.findViewById(R.id.texto_status_ocorrencia);
        TextView textoDataHora = convertView.findViewById(R.id.texto_data_hora);
